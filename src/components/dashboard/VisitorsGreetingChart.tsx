...
import { Card } from "@/ui/card"; // Adjust import for shadcn/ui

const VisitorsGreetingsChart = () => {
  return (
    <div className="px-5 ">
    <Card className="bg-white shadow rounded-2xl px-6 pt-8 pb-2 w-full min-h-[210px] mt-10">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-2xl font-semibold text-gray-800">
          Visitors vs. Greetings
        </h2>
...
export default VisitorsGreetingsChart;
