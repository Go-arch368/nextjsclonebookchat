          ...
          <Table className="border border-gray-200 w-full">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="px-4 py-4 hover:bg-gray-100 w-1/12 text-center">Details</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {currentData.map((item) => (
                <TableRow key={item.id} className="hover:bg-gray-100">
                  <TableCell className="px-4 py-3 w-4/5 text-left text-ellipsis overflow-hidden max-w-0">{item.message}</TableCell>
                  <TableCell className="px-4 py-3 w-1/12 truncate text-center">{item.createdBy}</TableCell>
                  <TableCell className="px-4 py-3 w-1/12 truncate text-center">{item.company}</TableCell>
